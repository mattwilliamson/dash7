...
#define REG_TEST_1                      0x50  /* 8 addresses are available for
                                              tests from this one */
#define REG_TEST_LNA                    0x58
#define REG_TEST_2                      0x59  /* 21 addresses are available for
                                              tests from this one*/
#define REG_TEST_DAGC                   0x6
#define REG_TEST_3                      0x70
#define REG_TEST_AFC                    0x71
#define REG_TEST_4                      0x72  /* 14 addresses are available for
                                              tests from this one*/
...
#define TX_SUCCESS         0
#define TIMEOUT           -1
#define RECEIVE_CRC_ERROR -2
#define RECEIVE_TOO_LONG  -3
#define CHANNEL_BUSY      -4
 ...
 *
 * @return TX_SUCCESS if the transmission has been a success
 * @return CHANNEL_BUSY if the couldn't be made.
 */
 ...
 *
 * @return TIMEOUT           No packet have been received.
 * @return RECEIVE_CRC_ERROR The packet received is corrupt
 * @return RECEIVE_TOO_LONG  The packet received is larger than expected.
 * @return The size of the packet, if the packet is correct.
 */
